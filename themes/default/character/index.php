...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>	
		...
		<select name="online" id="online">
			<option value=""<?php if (!($online=$params->get('online'))) echo ' selected="selected"' ?>>Todos</option>
...
<table class="vertical-table">
	<tr>
		...
		<th><?php echo $paginator->sortableColumn('ch.online', 'Status') ?></th>
