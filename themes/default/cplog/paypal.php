...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		...
		...
		<label for="parent_txn_id">ID da Transação Pai:</label>
	...
	<p>
		...
		<select name="amount_op">
			<option value="eq"<?php if (($amount_op=$params->get('amount_op')) == 'eq') echo ' selected="selected"' ?>>é igual a</option>
			<option value="gt"<?php if ($amount_op == 'gt') echo ' selected="selected"' ?>>é maior que</option>
			<option value="lt"<?php if ($amount_op == 'lt') echo ' selected="selected"' ?>>é menor que</option>
		</select>
	...
	<p>
		<label for="use_processed_after">Processamento Entre:</label>
	...
	<p>
		<label for="use_received_after">Recebimento Entre:</label>
